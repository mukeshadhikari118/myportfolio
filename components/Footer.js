    ...
    >
      <main className="space-y-10 md:flex flex-row-reverse  items-center justify-between md:px-16 ">
        ...
        <div className="space-y-4">
          ...
          <a href='/sankalpa.pdf' download><button className="bg-yellow-400  select-none text-[10px] hover:-translate-y-1 shadow-xl tracking-wider uppercase font-extrabold text-gray-800 py-3 mt-5 px-10 transition-all duration-500 rounded-lg">
         Download cv
        </button></a>
        </div>
      </main>
