  ...
  return (
    <>
      ...
      >
        ...
        {mobileView && (
          <section
            className={`w-full absolute top-[75px] right-1 md:hidden text-right uppercase text-sm  font-bold tracking-widest  shadow-xl z-50 h-auto transition-all duration-500 flex flex-col  space-y-4 ${
              mode
