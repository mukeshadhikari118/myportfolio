    ...
    <main className=" px-6 md:px-20  py-4 flex flex-col md:flex-row items-center md:space-y-0  space-y-14">
      ...
      <section className="flex items-center md:items-start flex-col space-y-5 md:space-y-10 md:w-[40%]">
        ...
        <p
          ...
          } tracking-wide md:w-[85%] md:text-base`}
        >
          {desc}
        </p>
        ...
        <button
          ...
          className="bg-yellow-400 text-sm   hover:-translate-y-1 shadow-xl tracking-wider uppercase font-bold text-gray-800 py-3 px-10 transition-all duration-500 rounded-lg"
        >
          live link
        </button>
      </section>
